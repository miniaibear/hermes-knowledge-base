...
## query 2026-05-12 [深度诊断]
- 动作：dbs-action 执行力诊断（五条原因完整分析）
- 用户状态：系统性崩盘（交易失败→信任受损→财务焦虑→身份丢失）
- 核心诊断：不是懒，是受伤后持续往伤口上撒盐
- 关键发现：队友隐瞒的伤害不是钱，是"没有人真的希望你赢"的信念崩塌
- 写入：[[每日思考_2026-05-12]] 执行力诊断章节
- 建议下一步：找小事先做成一件 + 和队友摊牌 + 停止脑内重演
